"""
Django settings for sccs_supereduc project.
...
SECRET_KEY = '_9l5dg!3(i--5)eeggrrf*a@b+!eo7!$-r1*gp3-pse#@917#('
...
ROOT_URLCONF = 'sccs_supereduc.urls'
...
WSGI_APPLICATION = 'sccs_supereduc.wsgi.application'
